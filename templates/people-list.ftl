            ...
            <div class="col-md-12 chat-header">
                <div class="row header-one text-white p-1">
                    ...
                    <div class="col-md-6 name pl-2">
                        ...
                        <h6 class="ml-1 mb-0">${likedPerson.name} ${likedPerson.surname}</h6>
                    </div>
                        <#--cross-->
            ...
            <div class="chat-content">
                ...
                <div style="position: relative" class="col-md-12 p-2 msg-box border border-primary">
                    <div class="row">
                        ...
                        <#--text-->
                        <form action="/chat" method="post" class="col-md-11 pl-0">
                            <input name="text" style="width: 80%;" type="text" class="border-0" placeholder=" Send message"/>
                            <input name="user" type="hidden" value="${likedPerson.id}">
