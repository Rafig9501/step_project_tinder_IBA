...
public class ControllerServlets {
    ...
    public void run() {
        ...
        handler.addFilter(CookieFilter.class, USERS_PAGE, ft);
        handler.addFilter(CookieFilter.class, LIKE_PEOPLE_PAGE, ft);
        handler.addFilter(CookieFilter.class, MESSAGING_PAGE, ft);
