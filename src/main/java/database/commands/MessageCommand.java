...
public enum MessageCommand {
    ...
    GET_ALL("SELECT message_content.id, from_id, to_id, content, date_time FROM message_manager LEFT JOIN message_content on message_manager.message_content_id = message_content.id WHERE from_id = ? OR from_id = ? ORDER BY message_content.date_time");
